 ...
 * Trabalho Pratico 03 - FormPessoa2.java
...
public class FormPessoa2 extends Frame implements ActionListener{
    Button btnok,btnlimpar,btnmostrar,btnsair;
    TextField txtnumero,txtnome,txtidade;
    String sexo[]={"M","F"};
    JComboBox<String> cmbsexo;
    ...
    public FormPessoa2(){
        ...
        JFrame frame=new JFrame("TP03 - FormPessoa2");
    ...
    public void cadastrarPessoa(){
        if(txtnome.getText().isEmpty()||txtidade.getText().isEmpty()){
            ...
            if(isStringItrynteger(txtidade.getText())){
                ...
                Pessoa UmaPessoa=new Pessoa((txtnome.getText()),(cmbsexo.getSelectedItem().toString().charAt(0)),(Integer.parseInt(txtidade.getText())));
